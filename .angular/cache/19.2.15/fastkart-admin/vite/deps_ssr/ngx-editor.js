...
// node_modules/ngx-editor/fesm2015/ngx-editor.mjs
var import_rxjs = __toESM(require_cjs(), 1);
var import_operators = __toESM(require_operators(), 1);

// node_modules/ngx-editor/fesm2015/ngx-editor-utils.mjs
var isNil = (val) => {
...
var ParseContext = class {
  ...
  addDOM(dom) {
    if (dom.nodeType == 3) {
      ...
      if (marks2 != null) for (let i = 0; i < marks2.length; i++) this.addPendingMark(marks2[i]);
      this.addElement(dom);
      if (marks2 != null) for (let i = 0; i < marks2.length; i++) this.removePendingMark(marks2[i], top);
    }
  }
  addTextNode(dom) {
  ...
  */
  findIndex(pos) {
    ...
    for (let i = 0, curPos = 0; ; i++) {
      let cur = this.child(i), end = curPos + cur.nodeSize;
      if (end >= pos) {
        if (end == pos) return retIndex2(i + 1, end);
...
editHandlers.keypress = (view, _event) => {
  ...
  if (!(sel instanceof TextSelection) || !sel.$from.sameParent(sel.$to)) {
    ...
    if (!view.someProp("handleTextInput", (f) => f(view, sel.$from.pos, sel.$to.pos, text2))) view.dispatch(view.state.tr.insertText(text2).scrollIntoView());
    event.preventDefault();
  }
};
...
var MouseDown = class {
  ...
  up(event) {
    ...
    // works around that.
    chrome && !(this.view.state.selection instanceof TextSelection) && Math.min(Math.abs(pos.pos - this.view.state.selection.from), Math.abs(pos.pos - this.view.state.selection.to)) <= 2)) {
...
function mapChildren(oldChildren, newLocal, mapping, node, offset2, oldOffset, options) {
  ...
  let shift3 = (oldStart, oldEnd, newStart, newEnd) => {
    for (let i = 0; i < children.length; i += 3) {
  ...
  for (let i = 0; i < mapping.maps.length; i++) mapping.maps[i].forEach(shift3);
...
// node_modules/ngx-editor/fesm2015/ngx-editor-schema.mjs
var link = {
  attrs: {
    href: {},
    title: {
...
var listItem2 = Object.assign(Object.assign({}, listItem), {
  content: "paragraph block*"
});
var orderedList2 = Object.assign(Object.assign({}, orderedList), {
  content: "list_item+",
  group: "block"
});
var bulletList2 = Object.assign(Object.assign({}, bulletList), {
  content: "list_item+",
  group: "block"
});
var nodes = {
...
// node_modules/ngx-editor/fesm2015/ngx-editor-helpers.mjs
...
// node_modules/ngx-editor/fesm2015/ngx-editor-commands.mjs
var removeLink = () => {
...
function getNearestOverflowAncestor(node) {
  ...
  if (["html", "body", "#document"].includes(getNodeName(parentNode2))) {
...
var ImageRezieView = class {
  constructor(node, view, getPos, injector) {
    ...
    this.handleResize = () => {
      ...
      const transaction = tr.setNodeMarkup(this.getPos(), void 0, Object.assign(Object.assign({}, this.node.attrs), {
...
var Heading = class {
  ...
  toggle() {
    return (state, dispatch) => {
      ...
      return setBlockType2(type, Object.assign(Object.assign({}, attrs), {
        level: this.level
      }))(state, dispatch);
    };
  }
...
var Link$1 = class {
  ...
  insert(text2, attrs) {
    return (state, dispatch) => {
      ...
      const linkAttrs = {
        href: attrs.href,
        title: (_a = attrs.title) !== null && _a !== void 0 ? _a : text2,
...
var LinkComponent = class {
  constructor(el, ngxeService, menuService) {
    ...
    this.form = new FormGroup({
      href: new FormControl("", [Validators.required, Validators.pattern("(https?://)?([\\da-z.-]+)\\.([a-z.]{2,6})[/\\w .-]*/??([^#\n\r]*)?#?([^\n\r]*)|(mailto:.*[@].*)")]),
