...
app.use(cors({
  origin: ['http://localhost:4201', 'http://157.230.36.182:3004'],
  credentials: true
}));
...
app.post('/api/upload', (req, res) => {
  ...
  res.json({
    original_url: `http://157.230.36.182:3004/uploads/${filename}`,
    filename: filename
  });
});
...
app.post('/api/attachments', (req, res) => {
  res.json([{ original_url: 'http://157.230.36.182:3004/uploads/sample.jpg' }]);
});
