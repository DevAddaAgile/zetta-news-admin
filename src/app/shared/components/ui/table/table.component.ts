import { CommonModule, DatePipe, DOCUMENT, NgClass } from '@angular/common';
import { Component, EventEmitter, inject, Inject, Input, Output, Renderer2, ViewChild } from '@angular/core';
import { FormControl, ReactiveFormsModule } from '@angular/forms';
import { NgbCalendar, NgbDate, NgbDateParserFormatter, NgbInputDatepicker, NgbRating, NgbRatingConfig } from '@ng-bootstrap/ng-bootstrap';
...
@Component({
    ...
    imports: [ReactiveFormsModule, NgbInputDatepicker, NgClass, NgbRating,
        HasPermissionDirective, PaginationComponent, DeleteModalComponent,
        ConfirmationModalComponent, CommonModule, DatePipe, TranslateModule, CurrencySymbolPipe]
})
...
export class TableComponent {
  ...
  hasPermission(actions?: string[]) {
    // Always allow edit for switch toggles
